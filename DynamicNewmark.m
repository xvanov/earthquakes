function [t, d, v, a] = DynamicNewmark( M, C, K, F, t0, tf, h, d0, v0, beta, gamma )
%DynamicNewmark Solves the equation of motion Mx" + Cx' + Kx = F using the Newmark method.
%   Inputs
%   M           Mass matrix                     [n,n]
%   C           Damping matrix                  [n,n]
%   K           Elastic matrix                  [n,n]
%   F           Forcing vector                  [m,1]
